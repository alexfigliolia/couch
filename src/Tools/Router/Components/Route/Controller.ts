...
import type { IRouteState, Router } from "Tools/Router/Core";
import { RouteState } from "Tools/Router/Core";
import type { ITransitionName } from "Tools/Router/Transitions";
import { TransitionManager } from "Tools/Router/Transitions";
